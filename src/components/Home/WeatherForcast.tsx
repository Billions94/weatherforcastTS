        ...
        <>
          <div className="weather-side">
            ...
            <div className="date-container">
              <h2 className="date-dayname">
                {format(new Date(data.timezone * 24), "iii")}
              </h2>
              <span className="date-day">
                {format(new Date(data.timezone / 365), "dd MMM yyyy")}
              </span>
              <i className="location-icon" data-feather="map-pin" />
          ...
          <div className="info-side">
              ...
              <div className="today-info">
                ...
                <div className="wind">
                  ...
                  <span className="value">
                    {format(new Date(data.sys.sunrise), "hh:mm aa")}
                  </span>
                  <div className="clear" />
                </div>
                <div className="wind">
                  ...
                  <span className="value">
                    {format(new Date(data.sys.sunset), "hh:mm aa")}
                  </span>
                  <div className="clear" />
                </div>
              </div>
            ...
            <div className="d-flex location-container">
              ...
              <button
                onClick={(e) => addToFavorite(addToFavAction(data))}
                className="favorite-btn ml-2"
              >
                <i data-feather="map-pin" />
                <span>★</span>
              </button>
